...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    ...
    >
      <div
        className="bg-[#EFF4FF] rounded-full w-5 h-5 transform  flex items-center justify-center cursor-pointer transition-transform duration-200 group-data-[state=collapsed]:rotate-180 shrink-0 group-data-[state=collapsed]:mx-auto group-data-[state=collapsed]:translate-x-5"
        data-sidebar="trigger"
        data-slot="sidebar-trigger"
      >
        <svg
